...
Audited **283 HTML files** under `public/` plus the `assets/` tree. Run this any time before deploy to catch regressions.

## Summary

- Total HTML files in `public/`: **283**
- Sitemap URLs:                  **280**
  (2 expected exclusions: 404 page + draft way-cover pages)
- Internal links scanned:         **18792**
...
- Total `<a href>` scanned: 18792
- Resolved to file:        16354
- Resolved via redirect:   0
- External (skipped):      284
- Non-http skipped:        2154
- **Broken:**              **0**
...
- Pages with BreadcrumbList: 281 / 281 (excluding homepage and 404)
...
- Total `<loc>` entries: 280
- HTML files in `public/`: 283
