...
<img class="brand-hero-bg" src="/assets/images/services/repairs-fanuc-cnc-machine-repair-image.png" alt="Fanuc machine service work at Midwest CNC Services" loading="eager">
  ...
  <div class="brand-hero-content">
    <p class="eyebrow">Fanuc Spindle Repair &amp; Grinding</p>
    <h1>Fanuc Spindle Repair &amp; Rebuilds</h1>
    <p>Fanuc spindles tend to come in with high-speed bearing fatigue and taper wear from nonstop production use. We rebuild, regrind, and rebalance across the Fanuc platform &mdash; Robodrill α-D series &mdash; with most jobs running 3–4 weeks and field troubleshooting where it can save a teardown.</p>
    <div class="cta-row">
