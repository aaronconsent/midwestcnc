...
<div class="faq-item">
  <h3>What way-cover styles do you build for Makino machines?</h3>
...
<div class="faq-item">
  <h3>How long does a replacement Makino way cover take to build?</h3>
...
<div class="faq-item">
  <h3>Can you match an existing Makino way cover I have?</h3>
  <p>Yes. Send us the original (or measurements) and we&#x27;ll build a replacement to spec. We routinely match older inventory across the full Makino platform range.</p>
</div>
<div class="faq-item">
  <h3>Do you ship Makino way covers nationally?</h3>
