...
<img class="brand-hero-bg" src="/assets/images/services/way-covers-fanuc-cnc-way-covers-image.png" alt="Replacement Fanuc CNC way covers manufactured by Midwest CNC Services" loading="eager">
  ...
  <div class="brand-hero-content">
    <p class="eyebrow">Fanuc CNC Way Covers</p>
    <h1>Fanuc CNC Way Cover Replacement</h1>
    <p>We manufacture replacement way covers for Fanuc machines across the Robodrill α-D series. Most jobs ship in 2&ndash;4 weeks depending on dimensions and material. Bellows, telescoping steel, and roll-up styles available &mdash; we match the original or build to spec.</p>
    <div class="cta-row">
