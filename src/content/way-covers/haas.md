...
<img class="brand-hero-bg" src="/assets/images/services/way-covers-haas-cnc-way-covers-image.png" alt="Replacement Haas CNC way covers manufactured by Midwest CNC Services" loading="eager">
  ...
  <div class="brand-hero-content">
    <p class="eyebrow">Haas CNC Way Covers</p>
    <h1>Haas CNC Way Cover Replacement</h1>
    <p>We manufacture replacement way covers for Haas machines across the VF-2, VF-4, VF-6, UMC-750, and ST lathes. Most jobs ship in 2&ndash;4 weeks depending on dimensions and material. Bellows, telescoping steel, and roll-up styles available &mdash; we match the original or build to spec.</p>
    <div class="cta-row">
...
<p>We service Haas way covers across the full lineup. Pick your series for platform-specific repair and service detail.</p>
