...
<details class="faq-item">
  <summary>How long does a replacement Okuma way cover take to build?</summary>
...
<details class="faq-item">
  <summary>Can you match an existing Okuma way cover I have?</summary>
  <div class="faq-answer"><p>Yes. Send us the original (or measurements) and we&#x27;ll build a replacement to spec. We routinely match older inventory across the full Okuma platform range.</p></div>
</details>
<details class="faq-item">
  <summary>Do you ship Okuma way covers nationally?</summary>
