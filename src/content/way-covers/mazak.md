...
<img class="brand-hero-bg" src="/assets/images/services/way-covers-mazak-cnc-way-covers-image.png" alt="Replacement Mazak CNC way covers manufactured by Midwest CNC Services" loading="eager">
  ...
  <div class="brand-hero-content">
    <p class="eyebrow">Mazak CNC Way Covers</p>
    <h1>Mazak CNC Way Cover Replacement</h1>
    <p>We manufacture replacement way covers for Mazak machines across the Integrex i-Series, Quick Turn, Variaxis, HCN horizontals, and Nexus series. Most jobs ship in 2&ndash;4 weeks depending on dimensions and material. Bellows, telescoping steel, and roll-up styles available &mdash; we match the original or build to spec.</p>
    <div class="cta-row">
...
<p>We service Mazak way covers across the full lineup. Pick your series for platform-specific repair and service detail.</p>
