...
/* =================================================================
   Homepage hero — text-first, typographic. No image.
   Single block, no grid math, no positioning tricks. The accumulated
   side-by-side iterations all fought the van product photo's white
   background. Clean slate: H1 + lede + CTA + trust line.
   ================================================================= */
.page-section-hero {
  padding: 0;
  background:
    radial-gradient(60% 80% at 85% 20%, rgba(184, 52, 26, 0.06), transparent 70%),
    var(--bg);
}
...
.home-hero {
  ...
  margin: 0 auto;
  padding: clamp(3rem, 7vw, 5.5rem) var(--s-5) clamp(2.5rem, 5vw, 4.5rem);
  display: flex;
...
@media (max-width: 768px) {
  .home-hero { padding: clamp(2rem, 7vw, 3rem) var(--s-4); }
  .home-hero > .cta-row { width: 100%; }
}
